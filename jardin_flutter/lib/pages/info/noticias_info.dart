...
class NoticiasInfo extends StatefulWidget {
  String noticiaId;
  NoticiasInfo(this.noticiaId, {Key? key}) : super(key: key);

  @override
  State<NoticiasInfo> createState() => _NoticiasInfoState();
}

class _NoticiasInfoState extends State<NoticiasInfo> {
  @override
